...
//   useEffect(() => {
//     if (!token) {
//       toast.error("User not logged in or token expired");
//       navigate("/");
//       return;
//     }
...
//     <div style={styles.container}>
//       <h1 style={styles.header}>Marketers</h1>
//       <p>A marketer should not market one phone or add one link twice</p>
//       <form onSubmit={handleSubmit} style={styles.form}>
//         <div style={styles.field}>
//           <label>Company:</label>
//           <input
...
function Marketers() {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.header}>Marketers</h1>
      <p>A marketer should not market one phone twice neither add an already used link no use one link twice</p>
